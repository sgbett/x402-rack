...
!!! warning "Transitional — requires BRC-103 middleware for spec compliance"
    ...
    **For new integrations, prefer [`PayGateway`](bsv-pay.md) or
    [`BRC121Gateway`](brc-121.md).** Both work zero-config, require no custom
    client instrumentation, and — for BRC-121 — are themselves spec-compliant.
